...
<div style="margin-bottom:24px;">
    <h1 style="font-size:22px; font-weight:600; color:var(--gray-800); margin:0 0 4px;">Nueva publicación</h1>
    <p style="font-size:13px; color:var(--gray-400); margin:0;">Complete los campos para registrar una nueva publicación.</p>
</div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group full">
                    ...
                    <textarea name="abstract"
                        ...
                        placeholder="Resumen o descripción de la publicación...">{{ old('abstract') }}</textarea>
        ...
        <div class="card-body">
            <div class="file-input-wrap" onclick="document.getElementById('imagen').click()">
                ...
                <div id="preview-wrap">
                    ...
                    <div class="file-input-label"><span>Haz clic para seleccionar</span> o arrastra una imagen aquí</div>
            ...
            <div class="tags-grid" id="tags-grid">
                ...
                <label class="tag-label" id="tag-label-{{ $et->id }}">
                    <input type="checkbox" name="etiquetas[]" value="{{ $et->id }}"
                        {{ in_array($et->id, old('etiquetas', [])) ? 'checked' : '' }}>
                    {{ $et->nombre }}
                </label>
                @empty
...
<script>
    ...
    async function guardarEtiqueta() {
        ...
        try {
            ...
            // Agregar al grid de etiquetas sin recargar
